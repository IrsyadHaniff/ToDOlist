            ...
            <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
                <div class="flex lg:flex-1">
                    <a href="#" class="-m-1.5 p-1.5">
                        <span class="sr-only">ToDoList</span>
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    ...
                    <a href="#" class="text-sm/6 font-semibold text-white">List tugas</a>
                    <a href="#" class="text-sm/6 font-semibold text-white">Tugas selesai</a>
                    {{-- <a href="#" class="text-sm/6 font-semibold text-white">Dokumen</a> --}}
                </div>
                            ...
                            <div class="mt-6 flow-root">
                                <div class="-my-6 divide-y divide-white/10">
                                    <div class="space-y-2 py-6">
                                        ...
                                        <a href="#"
                                            class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">List tugas</a>
                                        <a href="#"
                                            class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Tugas selesai</a>
                                        <a href="#"
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                    <div
                        class="relative rounded-full px-3 py-1 text-sm/6 text-cyan-400 ring-1 ring-white/10 hover:ring-white/20">
                        Tugas selesai dengan cepat itu lebih baik.
                    </div>
                </div>
                <div class="text-center">
                    <h1 class="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl capitalize">Selesaikan dan buat jadwal tugas mu disini kawan</h1>
                    <p class="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">Mari buat penjadwalan tugas mu disini</p>
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="{{ route('app') }}"
                            ...
                            started</a>
                        <a href="#" class="text-sm/6 font-semibold text-white">Buat akun? <span
