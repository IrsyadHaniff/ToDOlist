...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    <div class="flex h-screen">
        ...
        <!-- Sidebar -->
        <div class="w-64 bg-white dark:bg-gray-800 shadow-lg flex flex-col select-none">

            <!-- HEADER -->
            <div class="p-6 flex items-center space-x-3">
                <h2 class="text-2xl font-bold flex-1 ">ToDOlist
                </h2>

                <!-- ICON MATAHARI (tampil saat LIGHT MODE) -->
                <div class="w-6 h-6 flex items-center justify-center">
                    <svg id="icon-light" class="w-6 h-6 cursor-pointer hidden" xmlns="http://www.w3.org/2000/svg"
                ...
                <ul class="space-y-2">
                    <li>
                        <a href=""
                            ...
                            {{ Request::routeIs('beranda') ? 'bg-blue-500 text-white' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                    ...
                    <li>
                        <a href=""
                            class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors
                            {{ Request::routeIs('list-tugas') ? 'bg-blue-500 text-white' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
